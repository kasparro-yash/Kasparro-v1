...
export default function App() {
	const [isDark, setIsDark] = useState(false); // light mode on by default
	...
	return (
		...
		>
			<div className={`h-screen flex flex-col ${t.canvas} font-sans`}>
				...
				{screen !== "module" && (
					<div
						className={`${t.surface} border-b ${t.border} px-6 py-2 flex items-center gap-3 z-10`}
					>
						...
						<span className={`text-xs ${t.textMuted} italic`}>
							dev preview · click tabs to jump screens
						</span>
					</div>
				)}
